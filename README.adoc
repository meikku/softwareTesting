Tournament Manager was a group project for the course 'Test logiciel' (= Software testing / 4 ECTS) taught by Mr Bousse at Nantes University in the autumn 2022.
